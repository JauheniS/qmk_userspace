...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_60_ansi(
        ...
        KC_LCTL,   KC_LOPT, KC_LCMD,                       KC_SPC,                              KC_RCMD,  MO(1),  KC_ROPT,       KC_RCTL
    ),
    [1] = LAYOUT_60_ansi(
    ...
    [2] = LAYOUT_60_ansi(
        ...
        _______,            UG_NEXT, UG_HUEU, UG_HUED, UG_SATU, UG_SATD, UG_VALU, UG_VALD, UG_SPDU, UG_SPDD, UG_TOGG, _______,
